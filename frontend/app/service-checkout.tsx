...
export default function ServiceCheckout(){
 ...
 return <SafeAreaView style={s.root}><View style={s.h}><Pressable onPress={()=>r.back()}><MaterialCommunityIcons name="arrow-left" size={24}/></Pressable><Text style={s.t}>Trip Checkout</Text></View><ScrollView contentContainerStyle={s.b}>
 ...
 <View style={s.card}><Text style={s.label}>BOOKING DETAILS</Text><Row k="Destination / Package" v={x.service_name||e.package_name}/><Row k="Travel date" v={x.booking_date}/><Row k="Travellers" v={String(x.quantity||1)}/><Row k="Vendor" v={x.vendor_name||"KMT Bazaar Tour & Travel"}/></View>
