...
function CartIcon({ color, size }: { color: string; size: number }) {
  ...
  useEffect(() => {
    if (badgePulse > 0) {
      scale.value = withSequence(withSpring(1.4, { damping: 5 }), withSpring(1, { damping: 6 }));
    }
  }, [badgePulse]);
...
const s = StyleSheet.create({
  badge: { position: "absolute", top: -6, right: -10, backgroundColor: COLORS.accent, minWidth: 18, height: 18, borderRadius: 9, paddingHorizontal: 4, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#fff" },
